...
EtResurrexitOrgano = {
  \relative c {
    ...
    \mvTr c4\fE-\soloE r8 g c4 r
    c8 c, c'2 d4~
    d e2 f4
    g8 g c, g' c, g' c, g'
    c, c g' g, c4-\tutti r8 g
    c4 r c r %115
    c8 c, c'4 d8 d, d'4
    e8 e, e'4 f8 f, fis'4
    g8 g, d'4 g, r
    \mvTr g\pE-\solo g' a g
    f! e d c %120
    h a d dis
    e4. \mvTr gis8\fE-\tutti a8. gis16 a8 gis
    ...
    d h e e, a4 c-\soloE
    d8 d, d'4 e8 e ,e'4
    f8 f, fis'4 g8 g, gis'4 %130
    a8 a, e' e, a4. gis8\pE
    a a' g! fis e fis g a
    h h, h' a g fis e d!16 c
    h4 h'8 a g fis e d!
    c h a4. h8 c a %135
    h4 r8 e c a h4
    e r a4.\fE a8
    ...
    a8\pE g fis4 g g,
    R1*2 %141
    r2 \mvTr g'4\fE-\tutti a
    fis g e fis
    g8 g, h g d'4 r
    R1 %145
    r4 r8 d g8. g16 g8 g
    g16 h a h g h a h g4 g,
    r \mvTr g'\pE-\solo a fis
    g e c d
    e4. c8 a2 %150
    d4 e8 h c a d d,
    g g'\fE h g c4 d
    h c d e
    c8 a d d, g4 r
    r8 c,-\tutti e f g4 g, %155
    r2 r8 c e f
    g4 g, r2
    r8 c e f g4 a
    f8 d g g, c4 \mvTr e8\pE-\solo c
    d4 g e8 d e c %160
    f4 f8 f f4 e
    d g c, f
    b, c f, r
    R1
    \mvTr d''4\fE-\tutti h! c c, \noBreak %165
    f2 e\fermata \bar "||"
    \clef "treble_8" << { g'4 a g r8 } \\ { r4 r8 f e[ d e] } >> \clef bass c \noBreak
    h a h g a4. a8
    g f g e f d e d16 c
    d2 c4 \clef treble << { e'' d r8 } \\ { r8 c h[ a h] } >> %170
    \clef "treble_8" g, fis e fis d
    e4. e'8 d c d h
    c a h a16 g a2
    \clef bass g4 a g r8 a
    a4 g g f %175
    f e8 \clef treble << { c'' a[ h c] } \\ { e, f[ d e] } >> \clef bass a,
    f e16 f d e f g e8 c c4
    g'4. g8 fis e fis d
    e4. e8 d c d h
    c a h g a4 d %180
    g, r g' a
    ...
    g f!8 f f4 e8 a,
    d c d h c4. d8
    e4 e, \clef "treble_8" c'' d %185
    c8 h c a \clef bass g f g e
    f4 r8 g c, h c a
    d4 e a, r8 \clef "treble_8" c'
    c4 h h a
    a g \clef bass g fis %190
    fis e e dis
    \clef "treble_8" << { e' g fis } \\ { r2 h,4 } >> \clef bass e,
    g fis8 h h4 a
    a g8 e h' a h h,
    e4 r8 e f! e16 f d e f g! %195
    e8 d16 e c d e f d8 c16 d h c d e
    c8 h16 c a h c d h8 g f'!16 g a h
    c8 c, r \clef "treble_8" c' h a h g
    a4 r8 a g f \clef bass c4
    e d8 e e4 d %200
    d c8 c c4 h8 g'
    a8. g16 a8 f g4. e8
    f8. e16 f8 d e d e c
...
EtResurrexitBassFigures = \figuremode {
  ...
  <9>4 <[6]> <_+>2
  r1 %145
  r4. <[_+]>4 <6 4>8 <[5] 3> <6 4>
  r1
  r4 <5>8 <6> <10 9>4 <6 5>
  <9> \bo <[5]>8 \bc <[6]> <6 5>4 \bo <[5] _+>8 \bc <[6] \t>
  <10 9>4 <\t 8> <_!>2 %150
  <7 _+> <6 5>4 <[_+]>
  r2 <6 5>4 \bo <[5] _+>8 \bc <[6] \t>
  <6 5>4 \bo <[5]>8 \bc <[6]> <10+ 9> <\t 8> <5>4
  <6 5> <[_+]>2.
  r2 \bo <[6 4]>4 \bc <[5 3]> %155
  r1
  r
  r
  <6 5>
  <6->4 \bo <[_-]> <6>4. \bc <[7-]>8 %160
  <4- 2>4 \bo <[3] 1> <4- 2> \bc <[6]>
  <7> <_-> <7[-]>2
  <6 5>1
  r
  r4 <[6]>2. %165
  ...
  r2.. <6>8
  <7>4 <6>8 q <7>4 <6>
  <7> <6>8 \bo <[6]>4 \bc q8 <6> \bo <[\tllur]>16 \bc <[6]>
  <7>4 <6>2. %170
  r4. <6>8 <7>4 <6>
  <7> <6> \bo <7 [_+]> \bc <6 [\t]>8 <6>
  r <6\\> <6>4 <7> <6\\>
...
AgnusOrgano = {
  \relative c {
    ...
    a4 a'8 g! f e d4
    e dis e8 d? e e,
    a4 \mvTr a'\fE-\tutti fis2
    g! e4. c8 \noBreak
    g'4 g, r2\fermata \bar "||" %15
    \clef "treble_8" \tempoDona c'4. c8 h4 h \noBreak
    c8 g c4. h16 a h8 a16 g
    a2 \clef bass << {
      g4 a8 h
      r c d e r a, g f
    ...
    c~-\tasto
    c
    \tempoDonaB f,2.-\markup \remark "accompagnato" f4
    c'1\fermata \bar "|." %50 finis
  }
}
